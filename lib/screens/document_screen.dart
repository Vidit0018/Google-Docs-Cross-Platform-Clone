...
class _DocumentScreenState extends ConsumerState<DocumentScreen> {
  ...
  @override
  void dispose() {
  // socketRepository.dispose(); // If you have a custom method to clear listeners
  _controller?.dispose();
  focusNode.dispose();
      ...
      setState(() {
        ...
        _controller = QuillController(
          document: content.isEmpty
              ? Document()
              : Document.fromJson(
                  content), // Assuming content is in JSON format
          ...
          leading: IconButton(
            ...
            onPressed: () {
              ...
              Routemaster.of(context)
                  .push('/'); // Go back when the icon is pressed
            },
          ),
                ...
                child: SizedBox(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      filled: true,
                      fillColor:
                          Colors.grey[200], // Optional for better visibility
                    ),
